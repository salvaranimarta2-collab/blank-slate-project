...
const NOTIFICATIONS: Array<{
  ...
  { title: "Partnership formed", description: "Move Europe and Starfish Foundation just partnered.", icon: <Users className="h-4 w-4 text-purple-600" /> },
  { title: "Grant awarded", description: "UNHCR Innovation Fund awarded a grant to your project.", icon: <HandCoins className="h-4 w-4 text-emerald-600" /> },
];
